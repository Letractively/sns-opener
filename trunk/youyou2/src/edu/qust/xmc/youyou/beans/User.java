...
public class User extends Observable implements Observer {
	...
	public  void addObserver(Observer follow,int groupId) {
		// 添加follows
	...
	public void update(Observable o, Object msg) {
		System.out.println("I am " + getName() + " and I was told by "
				+ ((User) o).getName() + " : " + ((TwitterMessage) msg).getContent());
	}

	public void publishMessage(TwitterMessage msg) {
